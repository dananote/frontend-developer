...
// 위 함수를 화살표 함수로 작성하면 아래와 같습니다. if문등 구문이 들어갈 경우 중괄호를 생략할 수 없다.
let 함수1 = (x, y) => x + y
...
let {one, two, three} = {two: 20, one: 10, three: 30} // 순서가 바뀌어도 잘 들어감
// 완쪽애서 one과 two, three는 변수
let {one: 10, two, three} = {two: 20, one: 10, three: 30} // error
let {one: 100, two, three} = {two: 20, three: 30} // error
